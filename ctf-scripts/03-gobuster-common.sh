...
gobuster dir -u "$full_url" -w /usr/share/seclists/Discovery/Web-Content/common.txt -o "gobuster-common-$strip" -t 30
echo "Scan complete. Results saved to gobuster-common-$strip"
